...
public class JelkaManager : MonoBehaviour {

    public Animator animator;
    public static bool waitActive = false;
    public static int currentLife = 24;
    private int LIFE = 24;
    ...
    void OnCollisionEnter2D(Collision2D collision)
    {
        ...
        if (collision.gameObject.tag == "Arrow" && !waitActive) { currentLife--; Debug.Log("JELKA LIFE: " + currentLife); }
        ...
        //    || heroAnimator.GetCurrentAnimatorStateInfo(0).IsName("Attack_Down"))) { currentLife--; Debug.Log("JELKA LIFE: " + currentLife); }
